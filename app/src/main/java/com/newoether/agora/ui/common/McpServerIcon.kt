...
/** MCP Server stroke glyph used by RikkaHub's HugeIcons integration. */
val McpServerIcon: ImageVector by lazy {
    ImageVector.Builder(
        name = "McpServer",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(
            ...
            curveTo(10.2237f, 17.0255f, 8.43272f, 17.0255f, 7.32822f, 15.921f)
            curveTo(6.22373f, 14.8164f, 6.22373f, 13.0255f, 7.32822f, 11.921f)
